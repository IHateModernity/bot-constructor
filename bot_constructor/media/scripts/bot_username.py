...
requests = [{'token': '1233', 'name_bot': 'bot_username', 'target_message': 'start', 'answer': 'first command'}, {'token': '1233', 'name_bot': 'bot_username', 'target_message': 'start', 'answer': 'first command'}, {'token': '1233', 'name_bot': 'bot_username', 'target_message': 'start', 'answer': 'first command'}]
